...
title: "Beyond the Mirror: Principles for Work in the Age of AI"
subtitle: "AI may complete the Information Age's technical promise. Its communal promise is still ours to build."
quote: "Hope has to take a form someone can live inside."
excerpt: "AI can take on more information work, but it cannot decide what work should mean for people. This manifesto argues for shared purpose, a living commons, coordinated autonomy, and shared gains as the foundations of communal work."
...
bullets:
  - Organize people and agents around shared purposes that participants can question and help shape.
  - Make knowledge a living commons that people can find, question, improve, and trust.
  - Give coordinated autonomy clear boundaries, visible dependencies, and named accountability.
  - Let contributors help decide how recovered time, capacity, and economic gains are shared.

description: "A manifesto for work in the age of AI: shared purpose, a living commons, coordinated autonomy, and shared gains that give people a meaningful part to play."
seo-description: "As AI takes on information work, organizations must build shared purpose, living knowledge, human agency, and gains that benefit the whole community."
...
image: /img/2026-09/Thru-the-Mirror-The-Future-of-work.webp
image-alt: "A person steps through an oval mirror from a dim office into a sunlit library where people gather around a shared table."
image-title: "Through the Mirror: The Future of Work"
image-description: "A person approaches a large oval mirror in a dim office lined with desks and filing shelves. Through the mirror, sunlight fills a timber-framed library where people gather around a wooden table surrounded by books and plants, with an empty chair waiting for another participant."
image-credits-title: "Through the Mirror: The Future of Work"
# Artist and source credits are pending.
image-credits-artist: ""
image-credits-artist-URL: ""
image-credits: ""
image-credits-URL: ""
image-credits-source: ""
image-credits-source-URL: ""
...
In [my 2009 writing on collaboration](https://tedt.org/a-model-for-collaboration-tools/), I described what happens when knowledge cannot be preserved, found, or checked against its purpose. People compensate. They schedule another meeting, ask someone who knows someone, or carry information from one tool into the next. The informal network becomes the way the formal organization gets anything done.
...
An earlier version of this argument appears in [my white paper on moving beyond Industrial Age utility practices](https://tedt.org/From-Industrial-Age-Utility-to-AI-Centric-Utility/). The practical concern there was preserving context as information moves through an organization. AI brings another possibility into view. The information can increasingly carry work with it.
...
In [*Agents Don’t Click*](https://tedt.org/Agents-Dont-Click/), I argued that software changes when agents become its operators. The visible interface becomes less central to routine execution, while authoritative records, permissions, and evidence become more consequential. The next question is what happens to the organization built around those interfaces.
...
Years ago, in [*Defending the Commons*](https://tedt.org/the-purpose-of-community-protection-of-the-commons/), I used a garden to distinguish a community from the resource it cares for and the value that resource produces. The people, their shared ground, and its fruit are different things. A useful organization has to care about all three.
...
The original [Agile Manifesto](https://agilemanifesto.org/) challenged rigid approaches to software development by emphasizing people, collaboration, and adaptation. Its [principles](https://agilemanifesto.org/principles.html) included self-organization, trust, and a sustainable pace. There is a great deal there worth carrying forward.
...
I have argued before that [AI adoption requires a change in the operating model](https://tedt.org/Beyond-the-Light-Bulb/). The communal question goes further. It asks what the new model owes to the people whose contributions make it possible. It asks whether a more capable institution can also become a place where people have a more meaningful part to play.
