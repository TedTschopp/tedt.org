...
title: "Don’t Build Her Another Chatbot"
subtitle: "Why agentic AI should start with stuck workflows, not another answer box"
quote: "A chatbot knows. An agent does."
excerpt: "The durable opportunity for agentic AI is not another chatbot. It is unfinished work: bounded workflows with business objects, rules, approvals, exceptions, and measurable outcomes."
source: "Original Content"
source-url: ""
call-to-action: "Discuss this on Mastodon"

date: 2026-05-16 09:00:00 -0700
update: 2026-05-16 09:00:00 -0700
...
bullets:
- Chatbots are useful, but they answer questions; agents participate in bounded workflows and help move work toward completion.
- Finance is an early agentic AI market because it has recurring deadlines, source systems, controls, exceptions, approvals, and measurable outcomes.
- Generic AI wrappers are being squeezed by frontier labs, consultancies, systems of record, private equity, and enterprise software vendors.
- Durable agent opportunities start with a specific business object, a documented process, careful permissions, human approval, and a way to measure whether the outcome improved.
- The best place to look is the Tuesday afternoon workflow held together by email, tribal knowledge, stale documents, spreadsheets, and one person who just knows how it works.

description: "An argument that enterprise AI builders should stop defaulting to chatbots and instead look for unfinished workflows with clear business objects, rules, approvals, exceptions, and measurable outcomes."
seo-description: "Don't build another AI chatbot. Build agentic workflows around stuck work, business objects, approvals, governance, and measurable outcomes."
...
image: "/img/2026-05/Linda.webp"
image-alt: "A woman sits calmly at the center of a busy office workflow, surrounded by spreadsheets, binders, notes, approval steps, data sources, calendars, email, and team chat panels connected by glowing lines."
image-artist: "Ted Tschopp"
image-artist-URL: "https://tedt.org/"
image-description: "A composed office worker sits at a crowded desk surrounded by the artifacts of organizational work: spreadsheets, binders, process notes, approval flows, data source panels, emails, calendar items, team chat messages, and handwritten institutional knowledge. Glowing lines connect the scattered systems and documents back to her, visualizing the essay's argument that some people become the undocumented workflow hub for a business process."
image-title: "Linda at the Center of the Work"
image_width: 1672
image_height: 941
...
1. There is a business object that has a data model.
2. There is a process.
3. There is a way to tell whether the result was good.
...
1. They start with the model.
2. Then they talk about document chunking.
3. Then they talk about the interface.
4. Then they talk about use cases.
5. They should start with the mess.
