...
- [Melee Weapons Overview](#melee-weapons-overview)
  ...
  - [Ion Weapons - Merged from Source 2](#ion-weapons---merged-from-source-2)
...
- [Weapon Properties from Gamma World](#weapon-properties-from-gamma-world)
- [Damage Type](#damage-type)
  - [Acid (type)](#acid-type)
  - [Bludgeoning (Type)](#bludgeoning-type)
  - [Cold (Type) - Merged from Source 2](#cold-type---merged-from-source-2)
  - [Fire (type)](#fire-type)
  - [Force (type)](#force-type)
  - [Lightening / Electrical / Energy (type)](#lightening--electrical--energy-type)
  - [Necrotic/Radiation (Type)](#necroticradiation-type)
    - [Radiation (Type) -- Merged from Source 2](#radiation-type----merged-from-source-2)
  - [Piercing (type)](#piercing-type)
    - [Ballistic (Type)](#ballistic-type)
      - [Additional Rules needed?](#additional-rules-needed)
  - [Poison (type) -- Merged from Source 2](#poison-type----merged-from-source-2)
  - [Psychic / Spiritual (type)-- Merged from Source 2](#psychic--spiritual-type---merged-from-source-2)
  - [Radiant (type) -- Merged from Source 2](#radiant-type----merged-from-source-2)
  - [Slashing (Type)](#slashing-type)
  - [Thunder / Sonic (Type)](#thunder--sonic-type)
...
## Ion Weapons - Merged from Source 2
...
# Weapon Properties from Gamma World
...
This weapon has an acidic component.  

## Bludgeoning (Type)

This is a damage type. It may also be referred to as bashing or blunt damage.

## Cold (Type) - Merged from Source 2

This weapon does Cold Damage - All forms sources of low temperatures including mutation abilities and the environments of open space deal cold damage.

## Fire (type)

All forms of fire including those generated by the rapid oxidation of combustible materials deal fire damage.

## Force (type)

Force is pure energy focused into a damaging form. Most effects that deal force damage are force field effects weaponized.

## Lightening / Electrical / Energy (type)
...
## Poison (type) -- Merged from Source 2
...
Venomous stings and the toxic gas released from the marsh deal poison
damage. Chemical weapons do poison damage.

## Psychic / Spiritual (type)-- Merged from Source 2

Many mental mutations deal psychic damage.

## Radiant (type) -- Merged from Source 2

Radiant damage is dealt by lasers.
...
This is a damage type from sound, often causing shockwave.
