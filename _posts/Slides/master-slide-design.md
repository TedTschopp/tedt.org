...
aspect_ratio: 16:9
date: 2025-01-18
description: "Merged Swiss minimalist design patterns with a comprehensive library of professional slide archetypes for executive decks."
topics:
  - design
  - archetypes
...
<section>
  <h1>AI4IT Strategy 2026</h1>
  <h2>Building an AI-Enabled Future for Enterprise IT</h2>
  <div class="bar"></div>
  <p class="fragment">Ted Tschopp — The Tschopp Collective</p>
</section>

<section>
  <h2>Vision (Swiss Layout)</h2>
  <div class="columns">
    <div>
      <p>We are transforming IT into an intelligent, adaptive system driven by AI — a framework where automation, reasoning, and innovation converge.</p>
    </div>
    <div class="highlight-box">
      <p><strong>Key Principles:</strong></p>
      <ul>
        <li>Human-centered AI integration</li>
        <li>Transparent and governed systems</li>
        <li>Continuous modernization and simplification</li>
      </ul>
    </div>
  </div>
  <footer>The Tschopp Collective | Enterprise AI Architecture</footer>
</section>
