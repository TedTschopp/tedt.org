...
summary: "A scriptable scratchpad for developers. 65 built-in text transformations — encoding, formatting, hashing, case conversion, and more — all in the browser."
...
features:
  - "65 built-in text transformations"
...
Morph is a browser-based text transformation workbench with 65 built-in scripts.
