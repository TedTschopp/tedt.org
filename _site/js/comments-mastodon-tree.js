// (Removed YAML front matter markers accidentally introduced)
        ...
        function getImageFromBlurHash(blurhash, width = 32, height = 32) {
            // Check if decode function is available
            if (typeof decode === 'undefined' && window.BlurHash && window.BlurHash.decode) {
                window.decode = window.BlurHash.decode;
            }
            
            if (typeof decode === 'undefined') {
                console.warn('BlurHash decode function not available');
                return null;
            }
            ...
            try {
                ...
                console.warn('Error decoding BlurHash:', error);
                return null;
            }
        }
